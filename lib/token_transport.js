...
function TokenTransport(flavor, transportMethod, key, injectOpts = {}) {
  ...
  return {
    extractToken(req) {
      return transports[this.flavor][this.transportMethod].call(this, req);
    },
    injectToken(res, token) {
      return transports[this.flavor][this.transportMethod].call(this, res, token);
    }
  };
} module.exports = TokenTransport;
